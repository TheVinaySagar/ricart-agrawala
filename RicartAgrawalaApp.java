    ...
    private void initializeRegistry() throws Exception {
        try {
            ...
            try {
                ...
                Logger.error("NodeRegistry service not found. Please start the registry server first.");
                throw new Exception("NodeRegistry service not found at " + Config.RMI_REGISTRY_HOST + ":" + Config.RMI_REGISTRY_PORT + 
                                  ". Please start the registry server using start_registry.sh");
            }
        } catch (Exception e) {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            if (registryMode) {
                ...
                Logger.info("Nodes can connect to this registry at " + Config.RMI_REGISTRY_HOST + ":" + Config.RMI_REGISTRY_PORT);
